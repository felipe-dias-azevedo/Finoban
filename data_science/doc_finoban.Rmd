...
```{r}
df <- data.frame(idade,regiao.r,valorImovel,renda,tempoFinanciamento,`%rendaFinanciamento`, banco.r,avaliacao.r, dataHoraEntrada, dataHoraSaida, dataHoraAvaliacao,paginaSaida.r,statusSaida,paginaSaida)
...
```{r}
##valor de imovel/renda

plot(renda,valorImovel,main = "imovel/renda", xlab = "valor do imovel",ylab = "renda", pch=1)

cor.test(renda,valorImovel)
...
hist(renda,valorImovel, breaks = 10, col = "orange", main = "Histogram of Tree heights", xlab = "Height Bin")
```
